...
/**
 * MongoDB counterpart of {@code JpaOrderStoreSalesTest}: verifies the {@code $match → $unwind →
 * $group} sales pipeline produces the SAME revenue (Σ qty·unitPrice) and quantity (Σ qty) figures
 * the JPQL GROUP BY does — the store-swap parity guarantee for the legacy {@code getChartInfo}.
 */
@DataMongoTest
@Import(MongoOrderStore.class)
@ActiveProfiles("mongo")
class MongoOrderStoreSalesTest extends MongoTestBase {
